...
// Variables
const rootDomain = "lhuxman.my.id"; // Ganti dengan domain utama kalian
const serviceName = "lhux"; // Ganti dengan nama workers kalian
const apiKey = "OcpRKtIoOu6QtUFObI0Bs2YXs_kdPgVIpXRo06oo"; // Ganti dengan Global API key kalian (https://dash.cloudflare.com/profile/api-tokens)
const apiEmail = "lhuxpubg@gmail.com"; // Ganti dengan email yang kalian gunakan
const accountID = "faf57cfad30aaa17a6a00993963f0a09"; // Ganti dengan Account ID kalian (https://dash.cloudflare.com -> Klik domain yang kalian gunakan)
const zoneID = "f4999573b8877800a8792dd8843ee03c"; // Ganti dengan Zone ID kalian (https://dash.cloudflare.com -> Klik domain yang kalian gunakan)
...
const PROXY_BANK_URL = "https://raw.githubusercontent.com/lhuxman-lhux/openwrt/refs/heads/main/proxyList.txt";
